...
export class Utilities {
    ...
    public static simpleObject: any;
    ...
    public static cookies =
        {
            ...
            setItem: (sKey: any, sValue: string | number | boolean, vEnd: string | number, sPath: string, sDomain: string, bSecure: any) => {
            ...
            removeItem: (sKey: string | number | boolean, sPath: string, sDomain: string) => {
                if (!sKey) {
                    return false;
                }
...
;
    public static safeStringify(object: { [x: string]: any; hasOwnProperty: (arg0: string) => any; }) {
        ...
        for (const prop in object) {
            ...
            this.simpleObject[prop] = object[prop];
        }

        result = '[***Sanitized Object***]: ' + JSON.stringify(Utilities.simpleObject);
    ...
    /*Not use GetObjectWithLoweredPropertyNames service*/
